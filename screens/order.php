...
if ($_SESSION['zero']==1) {
   $sqls = "UPDATE tblproducts SET status = 'Unavailable' WHERE product_code='".$_SESSION['one']."'";
     mysqli_query($conn,$sqls)or die(mysqli_error($conn));
}
   ?>
<div class="col-lg-3">
  <div class="card mb-3">
    <div class="card-body">
      <form method="post" action="product.php?action=add&id=<?php echo $row["product_code"]; ?>">
         <center><img src="../Images/product.jpg" style="width: 100px">
         <h4 class="text-info"><?php echo $row["product_name"]; ?></h4>
         <h5 class="text-info">Available Qty:(<?php echo $row["quantity"]; ?>)</h5>
         <h4 class="text-danger">&#8373 <?php echo $row["price"]; ?>.00</h4>
